...
class Welcome extends BaseController
{
	...
	public function index()
	{
		...
		if (!$this->validate(['inputEmail'  => 'required'])) {
			...
			$inputEmail 		= htmlspecialchars($this->request->getVar('inputEmail', FILTER_SANITIZE_FULL_SPECIAL_CHARS));
			$inputPassword 		= htmlspecialchars($this->request->getVar('inputPassword', FILTER_SANITIZE_FULL_SPECIAL_CHARS));
	...
	public function registration()
	{
		if (!$this->validate([
			...
			$inputFullname 		= htmlspecialchars($this->request->getVar('inputFullname', FILTER_SANITIZE_FULL_SPECIAL_CHARS));
			$inputEmail 		= htmlspecialchars($this->request->getVar('inputEmail', FILTER_SANITIZE_FULL_SPECIAL_CHARS));
			$inputPassword 		= htmlspecialchars($this->request->getVar('inputPassword', FILTER_SANITIZE_FULL_SPECIAL_CHARS));
			$dataUser			= [
