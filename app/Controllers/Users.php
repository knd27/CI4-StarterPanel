...
class Users extends BaseController
{
	...
	public function createUser()
	{
		...
		$createUser = $this->userModel->createUser($this->request->getPost(null, FILTER_SANITIZE_FULL_SPECIAL_CHARS));
		if ($createUser) {
	...
	{
		$updateUser = $this->userModel->updateUser($this->request->getPost(null, FILTER_SANITIZE_FULL_SPECIAL_CHARS));
		if ($updateUser) {
			session()->setFlashdata('notif_success', '<b>Successfully update user data</b> ');
			return redirect()->to(base_url('users'));
		} else {
